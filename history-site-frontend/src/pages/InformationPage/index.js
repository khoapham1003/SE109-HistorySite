        ...
        <div className="infor-info-divide">
          ...
          <div className="infor-info-container">
            ...
            <div>
              ...
              Nhất. Căn cứ Quyết định số 709/QĐ-VPCP ngày 14 tháng 6 năm 2013
              của Bộ trưởng, Chủ nhiệm Văn phòng Chính phủ qui định chức năng,
              nhiệm vụ, quyền hạn và cơ cấu tổ chức của Hội trường Thống Nhất,
              thì Hội trường Thống Nhất là đơn vị sự nghiệp công lập thuộc Văn
              phòng Chính phủ có chức năng quản lý, bảo tồn, tôn tạo Di tích
              lịch sử Dinh Độc Lập; phục vụ đại biểu, khách tham dự các cuộc
              họp, hội nghị của Chính phủ, Thủ tướng Chính phủ và Văn phòng
              Chính phủ; các hội nghị và hoạt động khác của Đảng, Nhà nước, Quốc
              hội khi có yêu cầu; được tận dụng cơ sở vật chất, lao động để kinh
              doanh dịch vụ theo qui định của pháp luật.
            </div>
            <div>
