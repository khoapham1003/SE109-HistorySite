      ...
      <div className="infor-content">
        ...
        <div className="infor-info-container">
          ...
          <p>
            ...
            trường, đón khách ngay tại lối vào, quí du khách được thoải mái ngắm
            nhìn toàn cảnh khuôn viên dinh rộng 12ha, vừa được tìm hiểu về những
            điểm nổi bật cũng như giá trị lịch sử của di tích qua hệ thống
            thuyết minh tự động tích hợp trên xe điện.
          </p>
          <p>
          ...
          <p>
            Quý khách có thể liên hệ và đăng ký thuyết minh viên tại Quầy thông
            tin để được phục vụ theo mức phí qui định của Di tích với số lượng
            khách tối đa một đoàn là 25 người lớn hoặc 50 trẻ em (từ 15 tuổi trở
            xuống).
          </p>
          <div className="infor-img-container">
            <img
          ...
          <p>
            ...
            thức được đưa vào sử dụng để phục vụ khách tham quan di tích lịch sử
            Dinh Độc Lập từ tháng 8 năm 2017, với 10 thứ tiếng Anh, Pháp, Nhật,
            Trung Quốc, Hàn Quốc, Đức, Tây Ban Nha, Nga, Thái Lan và Việt Nam,
            đáp ứng nhu cầu của nhiều đối tượng khách tham quan từ khắp nơi trên
            thế giới.
          </p>
          <div className="infor-img-container">
            <img
          ...
          <p>
            Sau chương trình tham quan, tại điểm dừng chân, Quí khách có thể xem
            thêm bộ phim tư liệu “Lịch sử Dinh Độc Lập” thời lượng 30 phút tại
            các phòng chiếu phim tiện nghi, hiện đại, hỗ trợ 04 thứ tiếng Anh,
            Pháp, Nhật, Trung Quốc giúp cho chuyến tham quan di tích của Quí
            khách thêm sinh động và lý thú.
          </p>
          <p>
            Quý khách có thể đăng ký hình thức tham quan qua số điện thoại
            080.85039 – 080.85120 để được sắp xếp thời gian hợp lý và thuận tiện
          </p>
        </div>
      </div>
