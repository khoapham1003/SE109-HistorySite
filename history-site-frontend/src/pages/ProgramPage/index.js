    ...
    <div>
      ...
      <div className="infor-content">
        ...
        <div className="infor-info-container">
          ...
          <p>
            Chương trình Khám phá Di sản là một tập hợp các chủ đề được xây dựng
            trên cơ sở các hiện vật tại Di tích, tích hợp nhiều môn học như lịch
            sử, mỹ thuật, địa lý, tiếng Việt, giáo dục công dân … phù hợp với
            trình độ cũng như tâm sinh lý theo độ tuổi của học sinh.
          </p>
          <p>
            Mỗi chủ đề dài từ 90-100 phút, là một chuỗi các hoạt động phong phú,
            đa dạng, được thiết kế sáng tạo dưới hình thức “học mà chơi, chơi mà
            học”, không chỉ giúp học sinh hứng thú, chủ động tìm hiểu lịch sử,
            văn hóa dân tộc mà còn tạo điều kiện để học sinh phát huy tính sáng
            tạo, phát triển những kỹ năng quan trọng như làm việc nhóm, thuyết
