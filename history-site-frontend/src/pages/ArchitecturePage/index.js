      ...
      <div className="infor-content">
        ...
        <div className="infor-info-container">
          ...
          <p>
            ...
            thất cho đến tiền diện bên ngoài, tất cả đều tượng trưng cho triết
            lý cổ truyền, nghi lễ Phương đông và cá tính của dân tộc. Kiến trúc
            sư Ngô Viết Thụ đã kết hợp hài hoà giữa nghệ thuật kiến trúc hiện
            đại với kiến trúc truyền thống Phương Ðông. Toàn thể bình diện của
            Dinh làm thành hình chữ CÁT ( 吉 ) có nghĩa là tốt lành, may mắn;
            Tâm của Dinh là vị trí phòng Trình quốc thư; Lầu thượng là Tứ phương
            vô sự lầu hình chữ KHẨU ( 口 ) để đề cao giáo dục và tự do ngôn
            luận. Hình chữ KHẨU ( 口 ) có cột cờ chính giữa sổ dọc tạo thành
            hình chữ TRUNG ( 中 ) như nhắc nhở muốn có dân chủ thì phải trung
            kiên. Nét gạch ngang được tạo bởi mái hiên lầu tứ phương, bao lơn
            danh dự và mái hiên lối vào tiền sảnh tạo thành hình chữ TAM ( 三 ),
            theo quan niệm dân chủ hữu tam viết nhân, viết minh, viết võ, ý mong
            muốn một đất nước hưng thịnh thì phải có những con người hội đủ 3
            yếu tố Nhân, Minh, Võ. Ba nét gạch ngang này được nối liền nét sổ
            dọc tạo thành hình chữ VƯƠNG ( 王 ), trên có kỳ đài làm thành nét
            chấm tạo thành hình chữ CHỦ ( 主 ) tượng trưng cho chủ quyền đất
            nước. Mặt trước của dinh thự, toàn bộ bao lơn lầu 2 và lầu 3 kết hợp
            với mái hiên lối vào chính cùng 2 cột bọc gỗ phía dưới mái hiên tạo
            thành hình chữ HƯNG ( 興 ) ý cầu chúc cho nước nhà được hưng thịnh
            mãi.
          </p>
          ...
          <p>
            ...
            được biến cách từ bức cửa bàn khoa của các cung điện Cố đô Huế,
            không chỉ làm tăng vẻ đẹp của Dinh mà còn có tác dụng lấy ánh sáng
            mặt trời.
          </p>
          <p>
          ...
          <p>
            ...
            xanh của thảm cỏ tạo ra một cảm giác êm dịu, sảng khoái cho khách
          ...
          <p>
            ...
            ở vị trí trung tâm của khu đất. Ðây từng là nơi ở và làm việc Tổng
            thống Việt Nam Cộng hòa. Khu này có 03 tầng lầu, 02 gác lửng, 01 sân
            thượng, 01 tầng nền và tầng hầm. Tổng diện tích sử dụng là 20.000m²
            chia làm 95 phòng. Mỗi phòng có một chức năng riêng, kiến trúc và
            cách trang trí phù hợp với mục đích sử dụng của mỗi phòng. Sau 1975,
            khu nhà chính này tiếp tục được sử dụng một số phòng, còn lại để
